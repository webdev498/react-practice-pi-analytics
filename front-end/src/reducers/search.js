...
export const doSearch = (query: string, countryCode: string): Action => (dispatch: Dispatch) => {
  dispatch({type: Actions.START_SEARCH, payload: {query, loading: true}})
  dispatch({type: FetchActions.SEARCH_LAW_FIRMS, payload: {request: {searchTerm: query, countryCode}}})
}
